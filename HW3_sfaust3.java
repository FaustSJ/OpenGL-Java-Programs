...
public class HW3_sfaust3 extends J2_0_2DTransform
{
/*
...
//TRANSLATION         
       //makes the points
         gl.glPointSize(5);
         gl.glColor3d(1.0, 1.0, 0.0);
         my2dTranslatef((float)point6[2], (float)point6[3]);
         float firstPoint[] = {(float)point6[0],(float)point6[1]};
         transDraw(firstPoint);
         //line formed 
         gl.glColor3d(1.0, 0.0, 0.0);
         my2dTranslatef((float)point1[2], (float)point1[3]);
         float secondPoint[] = {(float)point1[0],(float)point1[1]};
         transDraw(secondPoint);
         my2dTranslatef((float)point2[2], (float)point2[3]);
         float thirdPoint[] = {(float)point2[0],(float)point2[1]};
         transDraw(thirdPoint);
         //forming the triangle 
         gl.glColor3d(1.0, 0.0, 1.0);
         gl.glPointSize(2);
         my2dTranslatef((float)point3[2],(float)point3[3]);
         ...
         transDrawTriangle(vert1, vert2, vert3);
     }
     //draws a transformed single point.
     public void transDraw(float[] v)
     {
    	 float v1[][] = new float[1][2];
    	 my2dTransformf(v, v1[0]);
    	 drawPoint((double)v1[1][0], (double)v1[1][1]);
     }
